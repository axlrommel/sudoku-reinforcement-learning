// @ts-nocheck
import { equals, flatten, pipe, filter, length, reject, sum, map, nth, tap, addIndex } from "ramda";
import { Entry, Observation, TileValue, FIRST_QUADRANT, SECOND_QUADRANT, THIRD_QUADRANT, FOURTH_QUADRANT } from "./types";
